    ...
    var e = {
      ...
      4087: (e, t, n) => {
        for (
          ...
          (s = o[a[l] + "Request" + i]), (u =
            o[a[l] + "Cancel" + i] || o[a[l] + "CancelRequest" + i]);
        if (!s || !u) {
          var c = 0,
            p = 0,
            d = [];
        ...
        (e.exports = function (e) {
          ...
          e ||
            (e = o), (e.requestAnimationFrame = s), (e.cancelAnimationFrame = u);
        });
      }
    },
      t = {};
      ...
      function S(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1), (r.configurable = !0), "value" in
            r && (r.writable = !0), Object.defineProperty(e, N(r.key), r);
        }
      }
      function A(e, t, n) {
        return (t = N(t)) in e
        ...
        function n(r, g) {
            ...
            (
              ...
              A(this, "runEventLoop", function () {
                ...
                if (!E.state.eventQueue.length) {
                  ...
                  (E.state.eventQueue = b(
                    E.state.calledEvents
                  )), (E.state.calledEvents = []), (E.options = w(
                    {},
                    E.state.initialOptions
                  ));
                }
                if (
                  (
                    ...
                    switch ((
                      ...
                      case i:
                        ...
                        E.options.onCreateTextNode &&
                          ...
                          (_ = E.options.onCreateTextNode(A, C)), _ &&
                          (N
                            ? N.appendChild(_)
                            : E.state.elements.wrapper.appendChild(
                              _
                        ...
                        if (E.state.visibleNodes.length) {
                          ...
                          E.options.onRemoveNode &&
                            ...
                            E.options.onRemoveNode({
                              node: G,
                              character: Y
                            }), G && G.parentNode.removeChild(G), q === y &&
                            I &&
                      ...
                      case h:
                        (E.options.cursor =
                          g.eventArgs.cursor), (E.state.elements.cursor.innerHTML =
                            g.eventArgs.cursor);
                    }
                    E.options.loop &&
                      (g.eventName === l ||
          ...
          g &&
            (this.options = w(
              w({}, this.options),
              g
            )), (this.state.initialOptions = w({}, this.options)), this.init();
        }
        var r, g;
        return (r = n), (g = [
          {
            ...
            value: function () {
              ...
              this.setupWrapperElement(), this.addEventToQueue(
                ...
                !0
              ), this.addEventToQueue(u, null, !0), !window ||
